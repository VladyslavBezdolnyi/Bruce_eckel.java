...
class DynamicDistribution {
    ...
    public static void main(String[] args) {
        String[] father = new String[200];
        CountrySequence randomIndex = new CountrySequence(father.length);


        for(int c : randomIndex.randomIndexSequence){
...
class CountrySequence{

    ArrayList<Integer> indexArray;
    int [] randomIndexSequence;

    double mean = 60; // cвязать amount с rank путем вызова функции
